...
public class com_keluts_warekfilm_model_ModelMovieRealmProxy extends com.keluts.warekfilm.model.ModelMovie
    implements RealmObjectProxy, com_keluts_warekfilm_model_ModelMovieRealmProxyInterface {
    ...
    private ProxyState<com.keluts.warekfilm.model.ModelMovie> proxyState;

    com_keluts_warekfilm_model_ModelMovieRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.keluts.warekfilm.model.ModelMovie>(this);
    ...
    @SuppressWarnings("cast")
    public static com.keluts.warekfilm.model.ModelMovie createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.keluts.warekfilm.model.ModelMovie obj = realm.createObjectInternal(com.keluts.warekfilm.model.ModelMovie.class, true, excludeFields);

        final com_keluts_warekfilm_model_ModelMovieRealmProxyInterface objProxy = (com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) obj;
        if (json.has("Id")) {
            if (json.isNull("Id")) {
    ...
    public static com.keluts.warekfilm.model.ModelMovie createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.keluts.warekfilm.model.ModelMovie obj = new com.keluts.warekfilm.model.ModelMovie();
        final com_keluts_warekfilm_model_ModelMovieRealmProxyInterface objProxy = (com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.keluts.warekfilm.model.ModelMovie copyOrUpdate(Realm realm, com.keluts.warekfilm.model.ModelMovie object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.keluts.warekfilm.model.ModelMovie) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.keluts.warekfilm.model.ModelMovie copy(Realm realm, com.keluts.warekfilm.model.ModelMovie newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.keluts.warekfilm.model.ModelMovie realmObject = realm.createObjectInternal(com.keluts.warekfilm.model.ModelMovie.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_keluts_warekfilm_model_ModelMovieRealmProxyInterface realmObjectSource = (com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) newObject;
        com_keluts_warekfilm_model_ModelMovieRealmProxyInterface realmObjectCopy = (com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.keluts.warekfilm.model.ModelMovie object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.keluts.warekfilm.model.ModelMovie.class);
        long tableNativePtr = table.getNativePtr();
        ModelMovieColumnInfo columnInfo = (ModelMovieColumnInfo) realm.getSchema().getColumnInfo(com.keluts.warekfilm.model.ModelMovie.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdIndex, rowIndex, ((com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) object).realmGet$Id(), false);
        String realmGet$Title = ((com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) object).realmGet$Title();
        if (realmGet$Title != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.TitleIndex, rowIndex, realmGet$Title, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.VoteAverageIndex, rowIndex, ((com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) object).realmGet$VoteAverage(), false);
        String realmGet$Overview = ((com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) object).realmGet$Overview();
        if (realmGet$Overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.OverviewIndex, rowIndex, realmGet$Overview, false);
        }
        String realmGet$ReleaseDate = ((com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) object).realmGet$ReleaseDate();
        ...
        String realmGet$PosterPath = ((com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) object).realmGet$PosterPath();
        ...
        String realmGet$BackdropPath = ((com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) object).realmGet$BackdropPath();
        ...
        String realmGet$Popularity = ((com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) object).realmGet$Popularity();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelMovieColumnInfo columnInfo = (ModelMovieColumnInfo) realm.getSchema().getColumnInfo(com.keluts.warekfilm.model.ModelMovie.class);
        com.keluts.warekfilm.model.ModelMovie object = null;
        while (objects.hasNext()) {
            object = (com.keluts.warekfilm.model.ModelMovie) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.keluts.warekfilm.model.ModelMovie object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.keluts.warekfilm.model.ModelMovie.class);
    ...
    public static com.keluts.warekfilm.model.ModelMovie createDetachedCopy(com.keluts.warekfilm.model.ModelMovie realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.keluts.warekfilm.model.ModelMovie unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.keluts.warekfilm.model.ModelMovie();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.keluts.warekfilm.model.ModelMovie) cachedObject.object;
            }
            unmanagedObject = (com.keluts.warekfilm.model.ModelMovie) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_keluts_warekfilm_model_ModelMovieRealmProxyInterface unmanagedCopy = (com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) unmanagedObject;
        com_keluts_warekfilm_model_ModelMovieRealmProxyInterface realmSource = (com_keluts_warekfilm_model_ModelMovieRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_keluts_warekfilm_model_ModelMovieRealmProxy aModelMovie = (com_keluts_warekfilm_model_ModelMovieRealmProxy)o;
