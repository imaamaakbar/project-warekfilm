package com.keluts.warekfilm.fragment;
...
import com.keluts.warekfilm.activities.DetailMovieActivity;
import com.keluts.warekfilm.adapter.MovieAdapter;
import com.keluts.warekfilm.adapter.MovieHorizontalAdapter;
        ...
        AndroidNetworking.get(ApiEndpoint.BASEURL + ApiEndpoint.SEARCH_MOVIE
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onError(ANError anError) {
                        progressDialog.dismiss();
                        Toast.makeText(getActivity(), "Tidak ada Signal!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
